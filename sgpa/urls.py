...
urlpatterns = patterns('',
     ...
     url(r'^ver_trabajo/(?P<id_hu>\d+)/(?P<orden>\d+)/$', 'sgpa.views.ver_trabajo_view',name="ver_trabajo"),
     url(r'^finalizar/(?P<id_hu>\d+)/(?P<codigo>\d+)/$', 'sgpa.views.finalizar', name="finalizar"),
     url(r'^finalizar_proyecto/(?P<codigo>\d+)/$', 'sgpa.views.finalizar_proyecto', name="finalizar_proyecto"),
